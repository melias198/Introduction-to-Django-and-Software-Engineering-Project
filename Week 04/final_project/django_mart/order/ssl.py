...
def sslcommerz_payment_gateway(request, id, user_id, grand_total):
    ...
    post_body['cus_email'] = 'request.data["email"]'  # Retrieve email from the current user session
    post_body['cus_phone'] = 'request.data["phone"]'  # Retrieve phone from the current user session
    post_body['cus_add1'] = 'request.data["address"]'  # Retrieve address from the current user session
    post_body['cus_city'] = 'request.data["city"]'  # Retrieve city from the current user session
